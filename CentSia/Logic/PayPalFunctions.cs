...
public class NVPAPICaller
{
    ...
    public string APIUsername = "claude.developer-facilitator_api1.gmail.com";
    private string APIPassword = "HB5J5Y484Y47DXNN";
    private string APISignature = "AiPC9BjkCyDFQXbSkoZcgqH3hpacApePtNF4rgrnQ6GX4srV5xfUCZsf";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "CentSia Sample Application";
        ...
        using (CentSia.Logic.ShoppingCartActions myCartOrders = new CentSia.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            CentSia.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
